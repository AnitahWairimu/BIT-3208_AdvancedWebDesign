...
## Version 1 - Project Setup
- Created GitHub repository
- Installed required tools (XAMPP, VS Code)
- Set up local development environment
- Created initial project structure

---

## Version 2 - UI Design Planning
- Designed layout structure of the system
...
* Learned PHP variables, functions, loops, and conditional statements.
...
* Implemented form submission and data processing.
* Learned how server-side scripts interact with databases.
...
* Created database tables using MySQL.
...
* Applied normalization up to Third Normal Form (3NF).
...
* Implemented password hashing using PHP.
* Added password verification during login.
* Created session-based authentication.
